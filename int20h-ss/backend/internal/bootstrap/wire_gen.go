...
func Up() (*Dependencies, error) {
	...
	dietService := diet.New(postgresPostgres)
	tagService := tag.New(postgresPostgres)
	dishService := dish.New(postgresPostgres)
	httpServer := httpserver.New(configConfig, service, userService, mediaService, facultyService, productService, groupService, notifierService, subjectService, activitiesService, eventService, assignmentsService, dietService, tagService, dishService)
