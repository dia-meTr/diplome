<template>
  <div class="account-list-container">
    <div
      ...
      <h1>Реєстрація платіжного рахунку      </h1>   
    ...
    <div
      ...
      <div class="account">
        ...
        <h6
          v-else
          class="danger">
          {{ selectedBankDigitsLength }} Будь ласка, введіть своє місце
        </h6>
      </div>
      <div class="phone">
        <input
          ...
          v-model="phoneNumber"
          oninput="this.value = this.value.replace(/[^0-9]/g, '')"
          :placeholder="`Введіть свій 11-значний номер мобільного телефону без -`"
          :maxlength="11"
          type="text" />
        <h6
