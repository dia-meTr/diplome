...
import (
	...
	"oss-backend/internal/service/diet"
...
func Up() (*Dependencies, error) {
	wire.Build(
		...
		wire.Bind(new(service.Product), new(*product.Service)),
		...
		//		wire.Bind(new(service.Diet), new(*diet.Service)),
		//		wire.Bind(new(service.Tag), new(*tag.Service)),
